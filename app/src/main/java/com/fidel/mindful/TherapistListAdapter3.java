...
public class TherapistListAdapter3 extends RecyclerView.Adapter<TherapistListAdapter3.ViewHolder> {

    private final List<TherapistProfiles> therapistProfiles;
    private final Context context;
    private OnItemClickListener listener; // Declare listener

    public TherapistListAdapter3(Context context, List<TherapistProfiles> therapistProfiles) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_therapists2, parent, false);
