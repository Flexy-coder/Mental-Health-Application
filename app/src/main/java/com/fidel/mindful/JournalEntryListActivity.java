...
public class JournalEntryListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseRef = FirebaseDatabase.getInstance().getReference("journal_client_data"); // Change "journal_entries" to your desired database reference
        ...
        fab.setOnClickListener(view -> {
            ...
            startActivityForResult(new Intent(this, JournalActivity.class), REQUEST_CODE_ADD_ENTRY);
        });
        ...
        if (currentUser != null) {
            ...
            userRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    // Clear the existing list of journal entries
                    adapter.clearJournalEntries();

                    // Create a set to store unique entry content
