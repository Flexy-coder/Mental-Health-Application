...
public class ChattingroomActivity extends AppCompatActivity {
    ...
    private String activityName = "ChattingroomActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fullName = getIntent().getStringExtra("chatroomName");
        ...
        messagesReference = FirebaseDatabase.getInstance().getReference("conversations").child(fullName);
