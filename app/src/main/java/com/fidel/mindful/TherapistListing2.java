...
public class TherapistListing2 extends AppCompatActivity implements TherapistListAdapter2.OnItemClickListener {
    private RecyclerView recyclerView;
    private TherapistListAdapter2 adapter;
    private List<TherapistProfiles> therapistProfiles;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_therapist_listing2);

        recyclerView = findViewById(R.id.recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        therapistProfiles = new ArrayList<>();
        adapter = new TherapistListAdapter2(this, therapistProfiles);
